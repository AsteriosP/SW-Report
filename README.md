...
[Επιλογή Εργαλείων](#επιλογή-εργαλείων)
...
- VSCode (Επεξεργασία και δειμιουργεία του κώδικα)
- Βιβλιοθήκη οπτικοποιήσης δεδομένων της Javascript: D3 
- Προγράμματα καταγραφής βίντεο από την οθόνη: LiteCam, bilt-in των Windows 10
- Προγράμματα επεξεργασίας βίντεο (ανοιχτού κώδικα): OpenShot
